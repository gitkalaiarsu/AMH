...
const SearchHistoryItemComponent = ({
  ...
  return (
    <button className="w-full max-w-80.75 mx-auto h-18 text-left px-5 py-3.5 rounded-[10px] bg-[color:var(--sidebar-element-bg)] hover:bg-[color:var(--sidebar-element-hover)] transition-colors relative block">
